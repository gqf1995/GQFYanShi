...
public class AskForLeaveAActivity extends BaseDataBindActivity<AskForLeaveDelegate, AskForLeaveBinder> {
    ...
    protected void bindEvenListener() {
        ...
        viewDelegate.viewHolder.lin7.setVisibility(View.GONE);
        viewDelegate.viewHolder.lin8.setVisibility(View.GONE);
    }
