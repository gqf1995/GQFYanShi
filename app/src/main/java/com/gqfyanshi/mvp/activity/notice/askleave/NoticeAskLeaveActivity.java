...
public class NoticeAskLeaveActivity extends BaseDataBindActivity<NoticeAskLeaveDelegate, NoticeAskLeaveBinder> {
    ...
    protected void bindEvenListener() {
        ...
        initToolbar(new ToolbarBuilder().setTitle("签批请假"));
        onRefush(1);
