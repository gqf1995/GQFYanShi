...
public class NoticeDecisionMakingActivity extends BaseDataBindActivity<NoticeEmergencyDelegate, NoticeEmergencyBinder> {
    ...
    protected void bindEvenListener() {
        ...
        initToolbar(new ToolbarBuilder().setTitle("决策参考"));
        onRefush(1);
