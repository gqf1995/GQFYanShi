...
public class NoticeMayorActivity extends BaseDataBindActivity<NoticeEmergencyDelegate, NoticeEmergencyBinder> {
    ...
    protected void bindEvenListener() {
        ...
        initToolbar(new ToolbarBuilder().setTitle("市长专报"));
        onRefush(1);
    ...
    private void onRefush(int pageNumber) {
        ...
        queryJsonBean.setModelId("16");
        queryJsonBean.setType("07");
