...
public class MsgDelegate extends BaseDelegate {
    ...
    public static class ViewHolder {
        ...
        public RoundButton tv_num5;
        public LinearLayout lin_msg5;
        ...
        public ViewHolder(View rootView) {
            ...
            this.tv_title5 = (TextView) rootView.findViewById(R.id.tv_title5);
            this.tv_num5 = (RoundButton) rootView.findViewById(R.id.tv_num5);
            this.lin_msg5 = (LinearLayout) rootView.findViewById(R.id.lin_msg5);
        }
