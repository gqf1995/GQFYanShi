package com.gqfyanshi.mvp.dialog;
...
public class UpdateDialog extends BaseDialog implements DialogInterface.OnCancelListener {
    ...
    protected void startInit() {
        ...
        tv_http.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                click(2);
                dismiss();
                UiHeplUtils.startWeb(mContext, appVersion.getApp_url());
            }
        });
    ...
    public void showDialog() {
        tv_title.setText("有新版本");
        tv_content.setText("需要更新到" + appVersion.getApp_version() + "版本");
