...
public class NoticeCityManuscriptsSendAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeCityManuscriptsSendAdapter(Context context, List<DocumentBean> datas) {
