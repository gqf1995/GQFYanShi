...
public class NoticeMsgStatisticalAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeMsgStatisticalAdapter(Context context, List<DocumentBean> datas) {
        super(context, R.layout.adapter_notice_mgs_statistical, datas);
    ...
    protected void convert(ViewHolder holder, DocumentBean s, final int position) {
        ...
        tv5.setText("详情");
        tv5.setTextColor(CommonUtils.getColor(R.color.mark_color));
