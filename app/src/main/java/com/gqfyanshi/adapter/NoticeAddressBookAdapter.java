...
public class NoticeAddressBookAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeAddressBookAdapter(Context context, List<DocumentBean> datas) {
        super(context, R.layout.adapter_notice_address_book, datas);
