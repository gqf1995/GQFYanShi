...
public class NoticeSendOfficialDocumentAdapter extends CommonAdapter<NoticeSendOfficialDocumentBean> {
    ...
    public NoticeSendOfficialDocumentAdapter(Context context, List<NoticeSendOfficialDocumentBean> datas) {
        super(context, R.layout.adapter_notice_send_official_document, datas);

    }

    public void setData(List<NoticeSendOfficialDocumentBean> datas) {
        this.mDatas.clear();
    ...
    @Override
    protected void convert(ViewHolder holder, NoticeSendOfficialDocumentBean s, final int position) {
