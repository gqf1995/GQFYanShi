...
public class NoticeSendOfficialDocumentAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeSendOfficialDocumentAdapter(Context context, List<DocumentBean> datas) {
