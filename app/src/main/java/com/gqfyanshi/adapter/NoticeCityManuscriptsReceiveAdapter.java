...
public class NoticeCityManuscriptsReceiveAdapter extends CommonAdapter<String> {
    ...
    public NoticeCityManuscriptsReceiveAdapter(Context context, List<String> datas) {
