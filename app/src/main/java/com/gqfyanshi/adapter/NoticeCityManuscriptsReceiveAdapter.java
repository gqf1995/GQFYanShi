...
public class NoticeCityManuscriptsReceiveAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeCityManuscriptsReceiveAdapter(Context context, List<DocumentBean> datas) {
    ...
    protected void convert(ViewHolder holder, DocumentBean s, final int position) {
        ...
        tv4.setText("详情");
        tv4.setTextColor(CommonUtils.getColor(R.color.mark_color));
