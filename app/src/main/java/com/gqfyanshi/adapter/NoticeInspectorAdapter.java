...
public class NoticeInspectorAdapter extends CommonAdapter<DocumentBean> {
    ...
    public NoticeInspectorAdapter(Context context, List<DocumentBean> datas) {
        super(context, R.layout.adapter_notice_inspector, datas);
