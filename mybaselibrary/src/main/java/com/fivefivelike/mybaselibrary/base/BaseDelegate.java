...
public abstract class BaseDelegate extends IDelegateImpl {
    ...
    public void addFragment(Fragment fragment, String tag, int index) {
        ...
        //        if (index < fragmentTags.size()) {
        //            fragmentTags.add(index, tag);
            ...
            if (fragmentManager.getFragments() != null) {
                if (fragmentManager.getFragments().size() > 0) {
                    for (int i = 0; i < fragmentManager.getFragments().size(); i++) {
                        ...
                        //                            fragmentTags.add(fragmentManager.getFragments().get(i).getTag());
                        ...
                        if (!TextUtils.isEmpty(tag)) {
                            ...
                            if (isInteger(index)) {
                                ...
                                fragmentList.put(Integer.parseInt(index), fragmentManager.getFragments().get(i));
                            }
                        }
                    }
                }
    ...
    public void showFragment(int index) {
        ...
        for (int i = 0; i < fragmentList.size(); i++) {
            Fragment fragment = fragmentManager.findFragmentByTag(list1.get(i) + fragmentTags.get(list1.get(i)));// fragmentList.get(i);
            if (fragment != null) {
