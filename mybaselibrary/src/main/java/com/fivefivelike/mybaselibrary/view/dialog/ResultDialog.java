    ...
    public ResultDialogEntity ShowResultDialog(FragmentActivity activity, String data, DefaultClickLinsener defaultClickLinsener) {
        if (!TextUtils.isEmpty(data)) {
            ...
            if ("1".equals(resultDialogEntity.getType())) {
                ...
                ToastUtil.show(TextUtils.isEmpty(resultDialogEntity.getTitle()) ? resultDialogEntity.getContent() : resultDialogEntity.getTitle());
                //Toast.makeText(activity.getApplicationContext(), resultDialogEntity.getTitle(), Toast.LENGTH_SHORT).show();
            }
